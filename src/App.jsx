...
const HatsuneNiku = props => <div className='min-w-[250px] mx-12 '>
...
const Coffee = props => <div className='mx-12 text-cyan-500 font-chakra animate-bounce pt-24'>
...
const DrBobert = props => <div className="text-white font-chakra max-w-[350px] w-screen md:w-auto mx-12">
  <div className="mb-2">
...
const Cash4Bones = props => <div className='mx-12 min-w-[250px]'>
